/*
 * WorkflowStoreManagerLocal.java
 *
 ...
 * History
 * 
 * 29/02/2008:	Provisional check in of a local interface for the workflow store management
...
public interface WorkflowStoreManagerLocal {
