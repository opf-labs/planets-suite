 ...
 */
public class CoreServiceDescriptionRegistryTests {
    ...
    public static void registryCreation() {
        registry = CoreServiceDescriptionRegistry.getInstance();
    }
    ...
    public void registerServiceDescription() {
        ServiceRegistryMessage message = registry.register(description1);
