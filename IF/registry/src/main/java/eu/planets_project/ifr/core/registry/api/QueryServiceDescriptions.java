 ...
 * @see CoreServiceDescriptionRegistryTests
 * @author Fabian Steeg (fabian.steeg@uni-koeln.de)
 */
public final class QueryServiceDescriptions {

    private List<ServiceDescription> descriptions = null;
    private static Log log = LogFactory.getLog(QueryServiceDescriptions.class
            .getName());

    /**
     * @param descriptions The descriptions to query
     */
    public QueryServiceDescriptions(final List<ServiceDescription> descriptions) {
