<%@ page import= "java.io.*, java.net.URLDecoder, java.net.URI, eu.planets_project.services.utils.FileUtils, eu.planets_project.tb.impl.data.util.DataHandlerImpl, eu.planets_project.tb.api.data.util.DigitalObjectRefBean, eu.planets_project.tb.impl.data.util.ImageThumbnail" %><% 
