...
import eu.planets_project.pp.plato.services.crib_integration.tu_client.MigrationPath;
import eu.planets_project.pp.plato.services.crib_integration.tu_client.ServiceRegistryServiceLocator;
import eu.planets_project.pp.plato.services.crib_integration.tu_client.ServiceRegistry_PortType;
import eu.planets_project.pp.plato.services.crib_integration.tu_client.TransportException;
import eu.planets_project.pp.plato.services.crib_integration.tu_client.UDDIException;
/**
 * Provides access to the CRiB service registry at http://apollon.ifs.tuwien.ac.at
 * 
 * @author Michael Kraxner
 *
 */

public class TUCRiBRegistryServiceLocator implements IPreservationActionRegistry {
    ...
    public void connect(String url)  throws ServiceException, MalformedURLException{
        lastInfo = "";
        serviceRegistryService = serviceRegistryServiceLocator.getServiceRegistry(
                new URL(url));
    }
    /**
