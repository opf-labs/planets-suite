...
rem  execute eu.planets-project.service.migration.generic.GenericMigratePublish_0_0
...
:execute
rem --------------------------------------------------------------------
rem execute lib/GenericMigrate-0-0.jar
rem --------------------------------------------------------------------
"%java%" %options% -jar "%execdir%\..\lib\GenericMigrate-0-0.jar" %*
goto exit
...
@echo "                                          GenericMigratePublish_0_0 "
