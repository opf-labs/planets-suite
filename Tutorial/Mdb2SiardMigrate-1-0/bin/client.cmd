...
rem execute eu.planets-project.service.migrate.MigrateClient_1
...
rem --------------------------------------------------------------------
set args=../testfiles/testin.mdb ../testfiles/testout.siard
if "%1"=="" goto opts
set args=
...
:execute
rem --------------------------------------------------------------------
rem execute MigrateClient_1 in lib/GenericMigrate-1-0.jar
rem with service parameter Mdb2SiardMigrate-1-0
rem --------------------------------------------------------------------
"%java%" %options% -cp "%execdir%\..\lib\GenericMigrate-1-0.jar" eu.planets_project.services.migrate.MigrateClient_1 -s Mdb2SiardMigrate-1-0 %args% %*
goto exit
...
@echo "Calling syntax                                                      "
@echo "  client.cmd  [-h] [-n <host>] [<input>] [<output>]                 "
@echo "executes                                                            "
@echo "  eu.planets-project.service.migrate.MigrateClient_1                "
@echo "in lib/GenericMigrate-1-0.jar                                       "
@echo "                                                                    "
@echo "Arguments:  (See user's manual for more detail).                    "
@echo "  -h        display usage                                           "
@echo "  <input>   input file to be migrated                               "
@echo "            (default: ../testfiles/testin.mdb)                      "
@echo "  <output>  output file for migrated content                        "
@echo "            (default: ../testfiles/testout.siard)                   "
