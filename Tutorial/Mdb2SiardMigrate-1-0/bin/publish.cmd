...
rem  execute eu.planets-project.service.migration.mdb2siard.Mdb2SiardMigratePublish_1_0
rem  in lib/Mdb2SiardMigrate-1-0.jar. 
rem  Version    : $Id$
...
:execute
rem --------------------------------------------------------------------
rem execute lib/Mdb2SiardMigrate-1-0.jar
rem --------------------------------------------------------------------
"%java%" %options% -jar "%execdir%\..\lib\Mdb2SiardMigrate-1-0.jar" %*
goto exit
...
@echo "executes                                                            "
@echo "  eu.planets-project.service.migration.mdb2siard.Mdb2SiardMigratePublish_1_0"
@echo "in lib/Mdb2SiardMigrate-1-0.jar                                       "
@echo "                                                                    "
