...
@Local
public interface IRunExperiments extends IWorkflowStep {
    
    public void upload();
    
    public void download(Object number);
    public void setUpload(Object number);
    public void removeUpload(Object number);    
    ...
    public void runEmulation(Object record);
