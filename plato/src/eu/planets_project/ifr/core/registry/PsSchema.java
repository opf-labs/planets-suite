 ...
 *       &lt;sequence>
 *         &lt;element name="categories" type="{http://planets-project.eu/ifr/core/registry}psCategory" maxOccurs="unbounded" minOccurs="0"/>
...
public class PsSchema {
    ...
    protected List<PsCategory> categories;
    ...
    public List<PsCategory> getCategories() {
        if (categories == null) {
            categories = new ArrayList<PsCategory>();
        }
