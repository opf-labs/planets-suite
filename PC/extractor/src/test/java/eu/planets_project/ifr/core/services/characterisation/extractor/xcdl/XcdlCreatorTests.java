...
public class XcdlCreatorTests {
        ...
        List<Prop> xcdlContent = Arrays
                .asList(
                        ...
                        Prop
                                ...
                                .build(),
                        /* Property sets: */
                        Prop.name("propertySet").type("id_1").props(
                                /*
                                 * The ref references a property's value set
                                 * (see below) via the type:
                                 */
                                Prop.name("ref").type("i_i1_i217_s4")
                                        .description("suggestedPaletteAlpha")
                                        .build(),
                                Prop.name("ref").type("i_i1_i217_s5")
                                        .description(
                                                "suggestedPaletteFrequency")
                                        .build()).build(),
                        /* Properties: */
                        Prop
                                .name("property")
                                ...
                                .props(
                                        Prop
                                                ...
                                                .description(
                                                        "suggestedPaletteFrequency")
                                                .build(),
                                        Prop.name("valueSet").type(
                                                "i_i1_i217_s5").props(
                                                Prop.name("labValue").values(
                                                        "0").description("int")
                                                        .unit("inch").build(),
                                                /*
                                                 * The data ref references a
                                                 * property set (see above) via
                                                 * the type:
                                                 */
                                                Prop.name("dataRef").type(
                                                        "id_1").description(
                                                        "global").build())
                                                .build()).build(),
                        Prop
                                ...
                                .props(
                                        ...
                                        Prop.name("valueSet").type(
                                                ...
                                                Prop.name("dataRef").type(
                                                        ...
                                                        "global").build())
                                                .build()).build());
        creator = new XcdlCreator(xcdlContent);
    ...
    public void testFaultyProp() {
        new XcdlCreator(Arrays.asList(Prop.name("some")
                .values("random", "prop").build()));
    }
}
