...
//				System.out.println(path.getInputFormat() + " --> " + path.getOutputFormat());
	...
	public ServiceDescription describe() {
        ...
        Parameter optionalXCELString = new Parameter("optionalXCELString", "the XCEL file as a String");
        optionalXCELString.setDescription("Could contain an optional XCEL String which is passed to the Extractor tool.\n\r" +
	...
	public MigrateResult migrate(DigitalObject digitalObject, URI inputFormat,
		...
		if (result != null) {
			...
			if (sizeInKB < MAX_FILE_SIZE) {
				try {
					resultDigOb = new DigitalObject.Builder(Content.byValue(result)).permanentUrl(new URL("http://planets-project.eu/services/pserv-pc-xcdlExtractor")).build();
