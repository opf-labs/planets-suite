...
@Stateless()
public class JhoveIdentification implements IdentifyOneBinary, Serializable {
	private static final String ENCODING = "utf-8";
	public static final String RESOURCES = "PC/jhove/src/resources/";
	...
	public enum FileType {
		...
		private FileType(String mime, String pronom, String sample) {
			this.mime = mime;
			this.pronom = pronom;
			this.sample = sample;
		}
	...
	@WebResult(name = IdentifyOneBinary.NAME + "Result", targetNamespace = PlanetsServices.NS
			...
			+ "Result")
	public Types identifyOneBinary(byte[] binary) {
		try {
	 ...
	 */
	private Types result(JhoveBase base) throws FileNotFoundException,
			URISyntaxException {
	 ...
	 * @throws URISyntaxException
	 */
	private URI uri(String mime) throws URISyntaxException {
