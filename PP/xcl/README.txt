...
(extractor, comparator, XCLExplorer).
...
and 'XCLExplorer' need to contain the compiled binary with the same same
name as these folders, and all included resources.
