 ...
 */
@Embeddable
public class SelfAddressImpl implements Address, Serializable {
     ...
     */
    public SelfAddressImpl(Address address) {
        if( address != null ) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SelfAddressImpl)) return false;

        final SelfAddressImpl address1 = (SelfAddressImpl) o;
