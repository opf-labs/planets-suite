...
public class ServiceRegistry 
{
	...
	public ServiceRegistry() {
		...
		try {
			//ServiceRegistryManager_Service locator = new ServiceRegistryManager_Service(new URL("http://planetarium.hki.uni-koeln.de:8080/registry-ifr-registry-ejb/ServiceRegistryManager?wsdl"), new QName("http://planets-project.eu/ifr/core/registry", "ServiceRegistryManager"));
	...
	public void registerServices() {
		try {
			...
			//serviceId = registerService(service, "Test1@localhost", "Test1.Desc", org);
			//service.setKey(serviceId);
			//registerBinding(service, "Binding.Name", "Bindin.Dsc", "http://dme023:8080/wdt-ifr-wdt-ejb/MonitorImpl?wsdl");
	...
	/**
	 * Method to programmatically add a services to the registry
	 */
	...
	/**
	 * Method to programmatically add a binding to the registry
	 */
	...
	/**
	* deprecated method to fill dummy services list
	*/
