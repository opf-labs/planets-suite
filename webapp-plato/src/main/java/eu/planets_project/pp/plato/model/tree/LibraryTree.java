...
public class LibraryTree implements Serializable {
    ...
    public void addMainRequirements() {
        ...
        r.setCategory(CriterionCategory.ACTION_JUDGEMENT);
        r.setName(CriterionCategory.ACTION_JUDGEMENT.toString());
        r.setPredefined(true);

        r = action.addRequirement();
        r.setCategory(CriterionCategory.ACTION_RUNTIME);
        r.setName(CriterionCategory.ACTION_RUNTIME.toString());
        r.setPredefined(true);
        
        r = action.addRequirement();
        r.setCategory(CriterionCategory.ACTION_STATIC);
        r.setName(CriterionCategory.ACTION_STATIC.toString());
        r.setPredefined(true);
