...
@Name("multTreeHelper")
public class MultTreeHelperBean implements Serializable  {
   
    /**
     * 
     */
    private static final long serialVersionUID = -2987344227978720081L;

    @In(required=false)
    ResultNode multNode;
    
    private final static Logger log = Logger.getLogger(MultTreeHelperBean.class);
