 ...
 */public interface IActionEvaluator extends IEvaluator {
     ...
     */
    String FORMAT_NUMBEROFTOOLS = "outcome://format/numberOfTools";
    ...
    /**
     * is it an open source tool?  (measure, boolean)
     */
    String ACTION_OPENSOURCE = "action://static/openSource";
     ...
     * atm: PCDL /License
     */
    String ACTION_LICENSE = "action://static/license";
    
    /**quality
     * is there batch support?  (measure, boolean)
     */
    String ACTION_BATCH_SUPPORT = "action://static/batchSupport";
    
    /**
     * is the filename retained?  (measure, boolean)
     */
    String ACTION_RETAIN_FILENAME = "action://static/retainFilename";    
