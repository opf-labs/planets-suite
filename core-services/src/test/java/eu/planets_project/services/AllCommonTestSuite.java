...
import eu.planets_project.ifr.core.common.conf.ServiceConfigTest;
...
@Suite.SuiteClasses( { ChecksumTests.class, DigitalObjectTests.class, MetadataTests.class, ContentTests.class,
        ...
        PropertyTests.class,
        CharacteriseResultTests.class, ServiceConfigTest.class } )
public class AllCommonTestSuite {/** Test Suite empty */}
