 ...
 * 
 */
@WebServiceClient(name = "DataManager", targetNamespace = "http://planets-project.eu/ifr/core/storage/data", wsdlLocation = "http://dme023:8080/storage-ifr-storage-ejb/DataManager?wsdl")
    ...
    extends Service
{
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://dme023:8080/storage-ifr-storage-ejb/DataManager?wsdl");
